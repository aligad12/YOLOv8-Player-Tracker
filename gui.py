...
output_video_path = 'tracked_players_outputvk.mp4'
...
# Convert frame to ImageTk format and display in GUI
    ...
    video_panel.config(image=frame_image_tk)
    video_panel.image = frame_image_tk

    # Set a shorter delay for faster playback (e.g., 10 ms)
    video_panel.after(10, update_frame)

# Start updating frames in GUI
update_frame()
...
with open('player_heatmaps.pklvk', 'wb') as f:
